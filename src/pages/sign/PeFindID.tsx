	...
	return (
		<div className={'signContainer'}>
			<section className={'infoArea'}>
				...
				<div>
					<div className={'tabMenu'}><TabMenu title={'개인회원'} focuson={true} /></div>
					<div className={'tabMenu'} onClick={(e) => goToURL(e, pageURL_Sign_CO_FindID)}><TabMenu title={'기업회원'} focuson={false} /></div>
				</div>
				...
				<InputWithAlert
					...
					max={100}
					type={'text'}
					onchange={(e: React.ChangeEvent<HTMLInputElement>) => inputHandler(e, 10, 'email', '이메일 주소는 ')}
				...
				<InfoAlert messageCode={'PE_FINDID_INFO'} />
			</section>
		</div>
	)
}

export default React.memo(PeFindID)