...
function ResumeDetail() {
	...
	// 모든 입력값의 초기값을 만든다.
	const initialValues = {
		resumeTitle: '다시 비상하고 싶은 개발자 입니다.',
		userName: '이시',
		userEmail: 'yisi@yisistory.com',
		mobileNumber: '010-1234-1234',
		agreeRequestContactInfo: '',
		basicAddress: '서울특별시 구로구 디지털로 29',
		detailAddress: 'JNK디지털타워',
		tag: ['AgainJob','개발자','다둥이엄마'],
		schoolGubun: '',
		schoolName: '다시할수있다대학교',
		majorName: '재도전학과',
		graduateYear: '',
		schoolInMethod1: '',
		schoolInMethod2: '',
		career: [],
		portFolio: [],
		profile: '<p>10년 경력의 Project Manager입니다.</p><p>육아로 인해 5년간의 경력 단절이 있지만 1개월의 시간만 주어진다면 예전의 모습으로 회사에 보탬이 될 수 있습니다.</p><p>고맙습니다. 베리 땡큐</p><p>아름다운 밤이네요~</p>'
	}
