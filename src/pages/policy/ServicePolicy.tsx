...
import {pageURL_Policy_Privacy} from '@env'
...
function ServicePolicy() {
    ...
    const [dropArray, setDropArray] = useState<object[]>([])


    useEffect(() => {
        setDropArray([{id: 1, title:'2023년 6월 1일'}, {id: 2, title:'2023년 5월 1일'}, {id: 3, title:'2023년 4월 1일'}, {id: 4,title:'2023년 3월 1일'}])
    },[])
    ...
    return (
        <main>
            <div className={'tabTitleArea'}>
                ...
                <span style={{cursor: 'pointer'}} onClick={(e) => goToURL(e, pageURL_Policy_Privacy)}><PageTitle title={'개인정보처리방침'} type={'notFocus'} /></span>
                <div className={'blankDiv'}></div>
                <div className={'policyHistory'}>
                    <Dropdown
                        Options={dropArray}
                        name={'policy'}
                        changeFunc={()=> alert('이전 약관을 불러옵니다.')}
                        defaultValue={'2023년 6월 1일'}
                    />
                </div>
            </div>
